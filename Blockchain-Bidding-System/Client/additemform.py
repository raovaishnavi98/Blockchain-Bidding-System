...
def start():
	...
	submit_btn= Button(top, text="SUBMIT", command="", relief=RIDGE, bg="#ff3333", activebackground="#ff3333", fg="white", font=("Times New Roman", 18), borderwidth="1", padx="10px").grid(row=7, column=0, columnspan=2)
